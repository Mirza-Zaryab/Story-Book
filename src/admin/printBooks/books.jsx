      ...
      <div className="flex justify-between w-full">
        <div className="w-full">
          <input
            ...
            value={url}
            type="text"
            className="bg-[#F0F2F6] appearance-none border rounded-md w-auto xl:w-full py-1 px-2 text-gray-400 leading-tight focus:outline-none focus:shadow-outline"
          />
        </div>
    ...
    <div className="p-4 ml-64 h-screen">
      ...
      {data.length > 0 ? (
              ...
              {data
                ?.map((book, i) => (
                  <tr className="bg-white border-b ">
                    ...
                    <td className="px-6 py-4">{book?.orderId}</td>
                    <td className="px-6 py-4">{book?.quantity}</td>
                    <td className="px-6 py-4">${book?.user_printCharges}</td>
                    <td className="px-6 py-4">
        ...
        <div className="min-h-screen flex justify-center items-center h-96 w-full">
          <h1 className="text-xl font-semibold text-[#779B9A]">
            Not have any Printed Book now.
          </h1>
        </div>
      )}
    </div>
