...
export default function AppToggle({
  ...
  return (
    <Switch.Group as="div" className="flex items-center  flex-col">
      <Switch.Label as="span" className="ml-3 mb-1 mt-2">
        <span className={`text-sm font-medium text-${textColor} tracking-wide`}>{label}</span>
