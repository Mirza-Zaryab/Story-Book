...
const BookCoverCroper = ({ image, setImageSelected, setImages, setLoading, setUploadImg, setIsCrop }) => { // file reader image
                ...
                >
                    <div className='flex flex-col w-2/3 h-4/5 bg-white p-20 rounded-lg shadow-2xl relative'>
                        ...
                        <div className="" style={{}}>
                            ...
                            <p onClick={handleSkipCrop} className='absolute right-2 bottom-2 text-gray-500 hover:text-teal-600 cursor-pointer'>Skip Cropping</p>
                        </div>
                    </div>
                </div>
            }
...
export default BookCoverCroper