...
export default function SideBarNav({ sidebarOpen, setSidebarOpen }: any) {
              ...
              <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full bg-white focus:outline-none">
                ...
                <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                  <div className="flex-shrink-0 flex items-center px-4">
                    <img  onClick={() => { navigate('/') }} className="h-auto w-40 cursor-pointer" src={logo} alt="MSV" />
                  </div>
        ...
        <div className="flex flex-col w-64">
          ...
          <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-gray-100">
            <div className="flex-1 flex flex-col   overflow-y-auto">
              <div onClick={() => { navigate('/') }} className="flex items-center flex-shrink-0 px-4 cursor-pointer">
